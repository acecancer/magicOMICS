...
| **[DNABERT-2](https://github.com/MAGICS-LAB/DNABERT_2)** | BERT Transformer (byte-pair encoding) | Up to 10k bp | Multi-species genomes (GUE benchmark) | Efficient long-range context, cross-species tasks | **Title:** DNABERT-2: Efficient Foundation Model and Benchmark For Multi-Species Genome<br>**Authors:** Zhihan Zhou, Yanrong Ji, Weijian Li, Pratik Dutta, Ramana Davuluri, Han Liu<br>**Venue/Year:** ICLR 2024 (arXiv 2023)<br>**Preprint:** [arXiv:2306.15006](https://arxiv.org/abs/2306.15006) | [GitHub Repository](https://github.com/MAGICS-LAB/DNABERT_2) | Genomic Understanding Evaluation (GUE) benchmark, 100+ species |
...
| Multi-modal |
| **[Isoformer](https://github.com/evo-design/evo)** | Multi-modal fusion of pre-trained encoders (DNA, RNA, Protein) | Up to 65,536 bp for DNA input | Embeddings from models like Nucleotide Transformer (DNA) & ESM-2 (Protein) | Predicting RNA transcript isoform expression from DNA sequences across tissues | **Title:** Multi-modal Transfer Learning between Biological Foundation Models <br>**Authors:** Juan Jose et al.<br>**Venue/Year:** *Arxiv*, 2024<br>**DOI:** [pre-print](https://arxiv.org/html/2406.14150v1) | [GitHub Repository](https://github.com/evo-design/evo) | Human transcriptome (GENCODE v44), GTEx v8 tissue expression data |
